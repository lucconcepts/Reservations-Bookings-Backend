<?php
if ($row25['ResortFee'] != '0'){
$rfee = "<tr>
    <td>Resort Fee:</td> <td>$".$row25['ResortFee']." ".$row25['ResortFeeStruct']."</td>
  </tr>";
} else {
$rfee = "";	
}

if ( $row25['Balanceto'] == 'Resort'){
	$balline = "<tr>
    <td>Balance Due:</td>
    <td> $".$row25['Balance']." due at check-in.</td>
    </tr>";
} else {
	$balline = "";
}
...
<br>
    ...
    <table>
    <tr>
	<td> Check In Time: ".date("h:ia", strtotime($row25['CheckInTime']))."</td>
	</tr>
	<tr><td> Check Out Time: ".date("h:ia", strtotime($row25['CheckOutTime']))."</td></tr>
