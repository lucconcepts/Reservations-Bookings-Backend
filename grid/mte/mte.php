...
class MySQLtabledit {
	...
	* MySQL Edit Table
	* 
	* Copyright (c) 2016 Martin Meijer - bookman.nl
	* 
	...
	*/
	...
	var $head_1;
	var $version = 'RRI Edit Tables | <a href="/indexrri.php">DashBoard</a> | <a href="/settings.php">Settings</a>'; // 3 feb 2017
	...
	####################
		...
		$this->content = "
			...
			<table cellspacing=0 cellpadding=10 style='margin:0 0 5px 0; width: $this->width_editor;'>
				<tr style='background:#626262; color: #fff'><td></td>$head</tr>
				$rows
			</table>
			Do you like this script? Commercial use? <a href='https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=EDRJWCVVYU6TE' style='color:black'>Please Donate</a>
			$this->nav_bottom
		";
	...
	##########################
		...
		echo "
			...
			<div class='mte_content'>
				<div class='mte_head_1'><a href='$this->url_script' style='text-decoration: none;color: #008FD4'>
				$this->head_1</a></div>
				$this->nav_top
				$this->htaccess_warning
				$this->content_saved
