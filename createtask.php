...
VALUES ("'.$AssignUser.'" , "'.$DueDate3.'" , "'.$CreateDate.'" , "'.$TaskName.'" , "'.$TaskNotes.'" , "'.$CreateUser.'");';
...
<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
  ...
  <?php
    while($user1 = mysqli_fetch_assoc($usersql)){
      ...
      <input type="text" name="DueDate" required="required" id="from" />
      </p>
    <p><label class="field">Task Name:</label>
        <input type="text" name="TaskName" size="25" value=""> </p>
        
      <p><label class="field">Task Details:</label>
        <textarea name="TaskNotes" size="75" value=""> </textarea></p>
      <p><center>
