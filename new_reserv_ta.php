...
<script>
function baldate(){
	var baltowho = document.getElementById('baltowho').value;
...
VALUES ("'.$title.'" , "'.$fname.'" , "'.$lname.'" , "'.$phone.'" , "'.$phone2.'" , "'.$email.'" , "'.$email2.'" , "'.$address.'" , "'.$address2.'" , "'.$city.'" , "'.$state.'" , "'.$zip.'" , "'.$country.'" , "'.$custnotes.'" , "'.$bookdate.'" , "'.$agent.'" , "'.$source.'" , "'.$resort.'" , "'.$unittype.'" , "'.$invtype.'" , "'.$woname.'" , "'.$checkin3.'" , "'.$checkout3.'" , "'.$nights.'" , "'.$dailyrate.'" , "'.$nettotal.'" , "'.$totalrate.'" , "'.$netrate.'" , "'.$netrrateprofit.'" , "'.$paytype.'" , "'.$deposit.'" , "'.$balance.'" , "'.$cctype.'" , "'.$ccnum.'" , "'.$expdate.'" , "'.$balto.'" , "'.$balduedate2.'" , "'.$status.'" , "'.$supresvnum.'" , "'.$guestreq.'" , "'.$resvnote.'" , "'.$iv.'");';
...
?><script>
window.location = '/email_cust_ta.php'
</script>
<?
...
<option value="Alabama">Alabama</option>
   ...
   <label class="field">Resort:</label>
    <input type="text" name="resort" id="skills" required="required" onblur="units()"/>
      ...
      <input type="text" name="invtype" hidden="" value="TA" required="required">
    ...
    <p><label class="field">Credit Card Number:</label>
      <input type="text" autocomplete="off" id="1" name="ccnum" onblur="validatecreditcard();"/><br />
    ...
    <p><label class="field">Balance:</label>
      ...
      <select name="balto" id="baltowho" required="required" onblur="baldate()">
