...
include 'rriconfigs/CustEmailTemplate_NR.php';
?>
...
<br /><a href="mailto:<?php echo $row25['Email']; ?>?subject=Rental Confirmation <?php echo $resvnum; ?>"><center><button id="button1" onclick="CopyToClipboard('div1')">Launch Customer Booking Email</button></a></center>
